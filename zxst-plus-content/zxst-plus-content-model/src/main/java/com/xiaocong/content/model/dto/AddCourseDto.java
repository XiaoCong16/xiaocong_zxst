...
// @NotEmpty(message = "课程名称不能为空")
 @NotEmpty(message = "新增课程名称不能为空",groups = {ValidationGroups.Insert.class,ValidationGroups.Update.class})
 @ApiModelProperty(value = "课程名称", required = true)
 private String name;

 @NotEmpty(message = "适用人群不能为空",groups = {ValidationGroups.Insert.class,ValidationGroups.Update.class})
 @Size(message = "适用人群内容过少",min = 3,groups = {ValidationGroups.Insert.class,ValidationGroups.Update.class})
